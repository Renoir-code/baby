...
|
*/
$config['base_url'] = 'http://localhost/baby/';
...
|
*/
$config['sess_driver'] = 'files'; // changed from db to files to database
$config['sess_cookie_name'] = 'ci_session'; // changed from ci_session TO sid
